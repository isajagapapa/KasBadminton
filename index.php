            ...
            <div class="col-lg-3">
              <div class="card shadow">
                <div class="card-body">
                  ...
                  <a href="pengeluaran_user.php" class="btn btn-info"><i class="fas fa-fw fa-align-justify"></i></a>
                </div>
              </div>
            </div>
            <div class="col-lg-3">
              <div class="card shadow">
                <div class="card-body">
                  ...
                  <a href="uang_kas_user.php" class="btn btn-info"><i class="fas fa-fw fa-align-justify"></i></a>
                </div>
              </div>
            </div>
          </div>
