	...
	<style>
		* {
		...
		body {
			...
			background-image: url(assets/img/img_properties/BadmintonWallpapers.jpg);
		}
...
<body>
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-4 mx-5 py-4 px-5 text-dark rounded border border-dark" style="background-color: white">
				<h3 class="text-center">UANG KAS BADMINTON</h3>
				<form method="post">
				...
				<div class="text-center ">
					<button class="btn btn-primary"><a href="index.php" style="color:white">User</a></button>
				</div>
			</div>
		</div>
	</div>
	...
	<footer style="position: absolute; bottom: 0; width: 100%; text-align: center;">
		<div style="background-color: transparent;" class="container-fluid mt-5">
			<div class="row justify-content-center">
				<div class="col-lg text-center text-white pt-4 pb-2" style="background-color: rgba(180,190,196,.9);">
					<p style=" color:black;">Copyright &copy; By<a href="https://www.instagram.com/isajagapapa/" target="_blank" style="color:black;"> <b>is aja gapapa</b></a> | All rights reserved.</p>
				</div>
			</div>
		</div>
	</footer>
